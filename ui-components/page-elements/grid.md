...
<!DOCTYPE html>
<!-- saved from url=(0034)http://getskeleton.com/#whatAndWhy -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <!-- FONT
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <link href="./Skeleton_ Responsive CSS Boilerplate_files/css" rel="stylesheet" type="text/css">

  <!-- CSS
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <link rel="stylesheet" href="./Skeleton_ Responsive CSS Boilerplate_files/normalize.css">
  <link rel="stylesheet" href="./Skeleton_ Responsive CSS Boilerplate_files/skeleton.css">
  <link rel="stylesheet" href="./Skeleton_ Responsive CSS Boilerplate_files/custom.css">

  <!-- Scripts
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <script type="text/javascript" async="" src="./Skeleton_ Responsive CSS Boilerplate_files/ga.js.download"></script><script id="twitter-wjs" src="./Skeleton_ Responsive CSS Boilerplate_files/widgets.js.download"></script><script src="./Skeleton_ Responsive CSS Boilerplate_files/jquery.min.js.download"></script>
  <script src="./Skeleton_ Responsive CSS Boilerplate_files/run_prettify.js.download"></script>
  <link rel="stylesheet" href="./Skeleton_ Responsive CSS Boilerplate_files/github-prettify-theme.css">
  <script src="./Skeleton_ Responsive CSS Boilerplate_files/site.js.download"></script>

  <!-- Favicon
  –––––––––––––––––––––––––––––––––––––––––––––––––– -->
  <link rel="icon" type="image/png" href="http://getskeleton.com/dist/images/favicon.png">

<script type="text/javascript" charset="utf-8" async="" src="./Skeleton_ Responsive CSS Boilerplate_files/button.6856485337f38b6f9a4326589121d792.js.download"></script></head>
<body class="code-snippets-visible has-docked-nav">
  ...
  <div class="container">
    <section class="header">
      ...
      <div class="value-props row">
        <div class="four columns value-prop">
          <img class="value-img" src="./Skeleton_ Responsive CSS Boilerplate_files/feather.svg">
          Light as a feather at ~400 lines &amp; built with mobile in mind.
        </div>
        <div class="four columns value-prop">
          <img class="value-img" src="./Skeleton_ Responsive CSS Boilerplate_files/pens.svg">
          Styles designed to be a starting point, not a UI framework.
        </div>
        <div class="four columns value-prop">
          <img class="value-img" src="./Skeleton_ Responsive CSS Boilerplate_files/watch.svg">
    ...
    <nav class="navbar">
      <div class="container">
        <ul class="navbar-list">
          <li class="navbar-item"><a class="navbar-link" href="http://getskeleton.com/#intro">Intro</a></li>
          <li class="navbar-item">
            <a class="navbar-link" href="http://getskeleton.com/#" data-popover="#codeNavPopover">Code</a>
            <div id="codeNavPopover" class="popover">
              <ul class="popover-list">
                ...
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#typography">Typography</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#buttons">Buttons</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#forms">Forms</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#lists">Lists</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#code">Code</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#tables">Tables</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#queries">Queries</a>
                </li>
                <li class="popover-item">
                  <a class="popover-link" href="http://getskeleton.com/#utilities">Utilities</a>
                </li>
              </ul>
            </div>
          </li>
          <li class="navbar-item"><a class="navbar-link" href="http://getskeleton.com/#examples">Examples</a></li>
          <li class="navbar-item">
            <a class="navbar-link" href="http://getskeleton.com/#" data-popover="#moreNavPopover">More</a>
    ...
    <div class="docs-section" id="intro">
      ...
      <iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" title="Twitter Tweet Button" src="./Skeleton_ Responsive CSS Boilerplate_files/tweet_button.c2fee4cea2b1b8626df3db7d9a85b72d.en.html" style="position: static; visibility: visible; width: 60px; height: 20px;" data-url="http://www.getskeleton.com"></iframe>
      ...
      <iframe src="./Skeleton_ Responsive CSS Boilerplate_files/github-btn.html" allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
      <iframe src="./Skeleton_ Responsive CSS Boilerplate_files/github-btn(1).html" allowtransparency="true" frameborder="0" scrolling="0" width="110" height="20"></iframe>
    </div>
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;!-- Standard Headings --&gt;
&lt;h1&gt;Heading&lt;/h1&gt;
&lt;h2&gt;Heading&lt;/h2&gt;
&lt;h3&gt;Heading&lt;/h3&gt;
&lt;h4&gt;Heading&lt;/h4&gt;
...
<!-- ————————————————————————————————————————————————————— -->
    ...
    <div class="docs-section" id="buttons">
      ...
      <div class="docs-example">
        <div>
          <a class="button" href="http://getskeleton.com/#">Anchor button</a>
          <button>Button element</button>
          <input type="submit" value="submit input">
          <input type="button" value="button input">
        </div>
        <div>
          <a class="button button-primary" href="http://getskeleton.com/#">Anchor button</a>
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;!-- Standard buttons --&gt;
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;!-- The above form looks like this --&gt;
&lt;form&gt;
  &lt;div class="row"&gt;
    &lt;div class="six columns"&gt;
      &lt;label for="exampleEmailInput"&gt;Your email&lt;/label&gt;
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;ul&gt;
  &lt;li&gt;Item 1&lt;/li&gt;
  &lt;li&gt;
    Item 2
    &lt;ul&gt;
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;pre&gt;&lt;code&gt;.some-class {
  background-color: red;
}&lt;/code&gt;&lt;/pre&gt;
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">&lt;table class="u-full-width"&gt;
  &lt;thead&gt;
    &lt;tr&gt;
      &lt;th&gt;Name&lt;/th&gt;
      &lt;th&gt;Age&lt;/th&gt;
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">/* Mobile first queries */
...
<!-- CODE EXAMPLE ———————————————————————————————————————— -->
<pre class="code-example"><code class="code-example-body prettyprint">/* Utility Classes */
...
<!-- ————————————————————————————————————————————————————— -->
    ...
    <div class="docs-section examples" id="examples">
      ...
      <div class="row example">
        <a class="example-screenshot-wrapper" target="_blank" href="http://getskeleton.com/examples/landing">
          <img class="example-screenshot" src="./Skeleton_ Responsive CSS Boilerplate_files/landing.jpg">
        </a>
        <div class="one-half offset-by-one-half column">
          ...
          <a class="button" href="http://getskeleton.com/examples/landing" target="_blank">Demo</a>
